...
-- Enable realtime replication for key tables so clients receive updates without refresh.
DO $$
BEGIN
  BEGIN
    ALTER PUBLICATION supabase_realtime ADD TABLE public.signals;
...
VALUES ('TradingSignal', 'TNYhMKhLQWz6d5oX7Kqj7sdUo8vNcRYuPE', 2.00, 50.00, 'UTC')
...
INSERT INTO public.subscriptions (user_id, status)
VALUES ('564440d5-5460-43e7-a86a-aae6ef9e142e', 'inactive')
ON CONFLICT DO NOTHING;
...
VALUES ('5a9d1ed2-55a4-47dc-8da1-cd46fa91ead1', 'active', now(), now() + interval '100 years')
ON CONFLICT DO NOTHING;
