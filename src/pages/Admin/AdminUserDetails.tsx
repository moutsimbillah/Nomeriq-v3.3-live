...
const AdminUserDetails = () => {
  ...
  const chartData = useMemo(() => {
    ...
    const startingBalance = profile?.starting_balance ?? (currentBalance - stats.totalPnL);
    if (trades.length === 0) {
      return [{
        date: "Now",
        ...
        <div className="glass-card p-6 shadow-none">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input value={editedTelegramUsername} onChange={e => setEditedTelegramUsername(e.target.value)} placeholder="@username" className="bg-secondary/50" />
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/30">
